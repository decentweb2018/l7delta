...
$bg_color       = ($section['fcwi__bg_color']) ? $section['fcwi__bg_color'] : '#ffffff';
$font_color     = ($section['fcwi__font_color']) ? $section['fcwi__font_color'] : '#000000';
$padding_top    = ($section['fcwi__padding_top']) ? $section['fcwi__padding_top'] : '0';
$padding_bottom = ($section['fcwi__padding_bottom']) ? $section['fcwi__padding_bottom'] : '0';
$padding_images = ($section['fcwi__padding_for_images']) ? $section['fcwi__padding_for_images'] : '0';
$margin_images  = ($section['fcwi__margin_between']) ? '' : 'column-padding-0';
$images         = $section['fcwi__images'];
...
<section class="fcwi">
  <div class="max-width-container row-flex <?php if(!$section['fcwi__margin_between']) { echo 'row-flex--no-padding'; } ?>">
    <?php if($images) : ?>
