...
?>
<section class="acf-flexible-builder-fullwidth-cta content_builder_block cta_block" id="acf-flexible-builder-fullwidth-cta-<?php echo get_row_index(); ?>">

	<a href="<?php echo $url; ?>" class="cta <?php echo $custom_class; ?>" target="<?php echo $new_window; ?>">
		<span><?php echo $label; ?> <span class="icon icon-fast-forward"></span></span>
	</a>
	...
	<!-- Background Options -->
		...
		<style>
			#acf-flexible-builder-fullwidth-cta-<?php echo get_row_index(); ?> {
